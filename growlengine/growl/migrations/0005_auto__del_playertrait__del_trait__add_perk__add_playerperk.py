...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'growl_trait')

        # Adding model 'Perk'
        db.create_table('growl_perk', (
        ...
        db.send_create_signal('growl', ['Perk'])

        # Adding model 'PlayerPerk'
        db.create_table('growl_player_perk', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['growl.Game'])),
        ...
        db.send_create_signal('growl', ['PlayerPerk'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Perk'
        db.delete_table('growl_perk')

        # Deleting model 'PlayerPerk'
        db.delete_table('growl_player_perk')
