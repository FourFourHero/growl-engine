...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PerkEffect'
        db.create_table('growl_perk_effect', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['growl.Game'])),
            ('perk', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['growl.Perk'])),
        ...
        db.send_create_signal('growl', ['PerkEffect'])

        # Adding model 'SkillEffect'
        db.create_table('growl_skill_effect', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['growl.Game'])),
            ...
            ('attribute_change_per_level_attribute_id', self.gf('django.db.models.fields.IntegerField')(default=None, null=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('growl', ['SkillEffect'])

        # Deleting field 'Perk.effect_access_skill_group'
        db.delete_column(u'growl_perk', 'effect_access_skill_group')

        # Deleting field 'Perk.access_skill_group_id'
        db.delete_column(u'growl_perk', 'access_skill_group_id')


    def backwards(self, orm):
        # Deleting model 'PerkEffect'
        db.delete_table('growl_perk_effect')

        # Deleting model 'SkillEffect'
        db.delete_table('growl_skill_effect')

        # Adding field 'Perk.effect_access_skill_group'
        db.add_column(u'growl_perk', 'effect_access_skill_group',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Perk.access_skill_group_id'
        db.add_column(u'growl_perk', 'access_skill_group_id',
