...
class PlayerPerkManager(models.Manager):
    pass
...
class PlayerPerk(BaseModel):
    ...
    objects = PlayerPerkManager()

    class Meta:
        db_table = 'growl_player_perk'
        app_label = 'growl'
...
def post_save_cache(sender, **kwargs):
    ...
    store_player_perk_in_cache(instance)
    logger.debug('post save!')

post_save.connect(post_save_cache, sender=PlayerPerk)